...
typedef void(BaseWindow::*VoidFunc)();
typedef ListItemInterface*(BaseWindow::*InsertItemFunc)(MyJson);

typedef std::function<void(LiveDanmaku)> DanmakuFunc;
typedef std::function<void(QString)> StringFunc;

class BaseWindow : public QMainWindow, public CommonValues, public NetInterface
{
    Q_OBJECT
