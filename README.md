...
每30秒欢迎一次用户；而若有25级及以上粉丝牌的用户进来，立刻欢迎，除非连续两人在5秒内进来，只欢迎前一人。
...
```
[%in_game_user%,%origin_gift_name%=小心心]***已解除禁言\n>unblock(%uid%)\n>removeGameUser(%uid%)
```

> 其中 `[...]***` 中的星号为优先级，保证数量超过其余弹幕即可。
>
> `%in_game_user%` 确保是扣 `1` 被禁言的，而非之前因为其他原因禁言的用户
