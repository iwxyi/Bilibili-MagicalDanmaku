...
一个Bilibili直播弹幕姬+答谢姬+点歌姬。

人性化交互，支持弹幕聊天、观众互动、自动点歌、数据统计、防喷禁言、大乱斗偷塔等等。

## 神奇

神奇在何处？哦，也就下面这些：

- 根据观众自身数据（上次进入、等级、粉丝牌、弹幕等），按条件欢迎
- 根据礼物价值，可使用不同语气程度发送答谢，支持发送多条
- 查看每名观众进来次数、礼物总计、弹幕记录等
- 按等级、粉丝牌等多个条件，并筛选关键词自动禁言
- 外语自动翻译、AI闲聊回复、生僻字读音等自动化功能
- 大乱斗最后时间自动使用n个吃瓜自动偷塔，并支持反偷塔（对面偷塔自己马上送更多的）
- 大乱斗查看双方串门的粉丝，并偷偷打小报告
- 粉丝变化、大乱斗状况、新人发言等种种变化
...
弹幕姬支持如同聊天软件的水群小窗，Shift+Alt+D快速弹出
