...
public:
    ...
    Q_INVOKABLE qint64 getUid() const { return danmaku.getUid(); }
    ...
    Q_INVOKABLE qint64 getTotalCoin() const { return danmaku.getTotalCoin(); }
    Q_INVOKABLE bool isFirst() const { return danmaku.isFirst(); }
    Q_INVOKABLE qint64 getReplyMid() const { return danmaku.getReplyMid(); }
