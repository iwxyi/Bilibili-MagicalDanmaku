#ifndef DANMAKUWRAPPERSTD_H
#define DANMAKUWRAPPERSTD_H

#include <QObject>
#include "livedanmaku.h"

class DanmakuWrapperStd : public QObject
{
    Q_OBJECT
public:
    DanmakuWrapperStd(const LiveDanmaku &danmaku, QObject *parent = nullptr)
        : QObject(parent), danmaku(danmaku)
    {}

    DanmakuWrapperStd(const DanmakuWrapperStd& other)
    ...
    Q_INVOKABLE std::string getUid() const { return danmaku.getUid().toStdString(); }
