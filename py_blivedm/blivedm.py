...
class BLiveClient:
    ...
    def _parse_room_init(self, data):
        ...
        print('roomid=', self._room_id, self._room_short_id, 'owner_id=',self._room_owner_uid)
        return True
    ...
    def _parse_danmaku_server_conf(self, data):
        ...
        print('token:', self._host_server_token)
    ...
    async def _send_auth(self):
        ...
        pack = self._make_packet(auth_params, Operation.AUTH)
        print(pack)
        f = open('C:/f.txt', 'wb')
        f.write(pack)
        f.close()
        await self._websocket.send_bytes(pack)
